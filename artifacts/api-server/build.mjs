...
const SHARED_EXTERNAL = [
  ...
  "oracledb", "mongodb-client-encryption", "nodemailer", "handlebars", "knex",
  "typeorm", "protobufjs", "onnxruntime-node", "@tensorflow/*", "@prisma/client",
...
async function buildAll() {
  ...
  // Build app.ts separately for use as a Vercel serverless function
  await esbuild({
  ...
  // Build full server entry (index.ts includes WebSocket)
  await esbuild({
